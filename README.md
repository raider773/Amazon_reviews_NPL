...
notebook_4 and notebook_5: Used the binary model from notebook_3 to predict ifnew self-made reviews are positive or negative. Notebook_4 is like hosting and notebook_5 would be the "client". 
